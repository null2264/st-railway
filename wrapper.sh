...
export SILLYTAVERN_GEMINI_API_VERSION="${SILLYTAVERN_GEMINI_API_VERSION:-v1beta}"
export SILLYTAVERN_REQUEST_COMPRESSION="${SILLYTAVERN_REQUEST_COMPRESSION:-false}"
#endregion
